...
{
    public class TextContent : DynamicObject, IDictionary<string, object>
    {
        #region Fields
        ...
        /// </summary>
        public TextContent(ITableSchema table)
        {
        ...
        public TextContent(IDictionary<string, object> dictionary,ITableSchema table)
        {
